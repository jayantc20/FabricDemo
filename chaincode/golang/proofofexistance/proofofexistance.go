...
func (s *SmartContract) Invoke(APIstub shim.ChaincodeStubInterface) sc.Response {
	...
	if function == "queryFunction" {
		return s.queryFunction(APIstub, args)
	} else if function == "invokeFunction" {
		return s.invokeFunction(APIstub, args)
	} else if function == "queryAllFunction" {
		return s.queryAllFunction(APIstub)
	}

	return shim.Error("Invalid Smart Contract function name.")
}

func (s *SmartContract) queryFunction(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func (s *SmartContract) queryAllFunction(APIstub shim.ChaincodeStubInterface) sc.Response {
